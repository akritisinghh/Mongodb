...
data = {
     "name" : "akriti",
     "mail_id" : "akriti@gmail.com",
     "subject" : ["data science", "big data", "data analysis"]
}

#multiple dictionary format --> JSON format
...
#Collection - storing data in table, bunch of information/data
database = client["myinfo"]
collection = database ["Akki"]
#collection.insert_one(data)
#collection.insert_many(list_of_records)   #many-->inserting multiple recods

collection1 = database ["D_Packet"]
data1 = {"packetType": "D",
